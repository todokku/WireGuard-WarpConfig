Since not everyone is aware how to use python to run the script or use it, i edited the original script made some aditional changes, packed it into an exe. 
For easy use.
